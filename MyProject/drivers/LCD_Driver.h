...
#define DATA_PORT		PORTD	//define MCU port connected to LCD data pins
#define CONTROL_PORT	PORTC	//define MCU port connected to LCD control pins
#define DATA_DDR		DDRD	//define MCU direction register for port connected to LCD data pins
#define CONTROL_DDR		DDRC	//define MCU direction register for port connected to LCD control pins
...
#define LCD_LINE0_DDRAMADDR		0x80
#define LCD_LINE1_DDRAMADDR		0xC0
